(function (translator) {
	translator.translations["es"] = {
		...
		"bip38alertpassphraserequired": "contraseña requerida para la llave BIP38",
		...
		"generatelabelkeypress": "O escribe caracteres aleatorios en esta caja de texto.", 
		...
		"footerlabeltranslatedby": "Traducción: Soluciones Marva",
		"footerlabelpgp": "PGP",
		...
		"statuslabelcryptogood1": "Su navegador puede generar claves aleatorias criptográficamente usando window.crypto.getRandomValues", 
		"statusokcryptogood": "OK",
		"statuslabelcryptobad": "&times; Oh no!", 
		"statuslabelcryptobad1": "Su navegador NO es compatible con window.crypto.getRandomValues. Usted debe utilizar un navegador más moderno con este generador para aumentar la seguridad de las claves generadas.",
		"statusokcryptobad": "OK", 
		"statuslabelunittestsgood": "&#10004; Bien",
		"statuslabelunittestsgood1": "Todas las pruebas unitarias sincrónicas pasadas.", 
		"statusokunittestsgood": "OK", 
		"statuslabelunittestsbad": "&times; Oh no!", 
		"statuslabelunittestsbad1": "Algunas pruebas unitarias sincrónicas NO pasaron. Usted debe encontrar otro navegador para utilizar con este generador.", 
		"statusokunittestsbad": "OK", 
		"statuslabelprotocolgood": "&#10004; Bien!", 
		"statuslabelprotocolgood1": "Está ejecutando este generador desde su equipo local. <br />Tip: Compruebe dos veces que está fuera de línea al intentar ", 
		"statusokprotocolgood": "OK", 
		"statuslabelprotocolbad": "&#9888; Piénsalo dos veces!", 
		"statuslabelprotocolbad1": "Usted parece estar ejecutando este generador en línea desde un sitio web en vivo. Para carteras valiosas se recomienda", //TODO: please translate
		"statuslabelprotocolbad2": "descargar", 
		"statuslabelprotocolbad3": "el archivo zip de GitHub y ejecute este generador sin conexión como un archivo html local.", //TODO: please translate
		"statusokprotocolbad": "OK", 
		"statuslabelkeypool1": "Este es un registro de todas las direcciones Bitcoin y claves privadas que generó durante su sesión actual. Al volver a cargar la página se creará una nueva sesión.", //TODO: please translate
		"statuskeypoolrefresh": "Recargar", 
		"statusokkeypool": "OK", 
		...
		"singletip1": "<b>Una billetera Bitcoin</b> es tan simple como un solo emparejamiento de una dirección Bitcoin con su clave privada Bitcoin correspondiente. Tal billetera se ha generado para usted en su navegador web y se muestra arriba.", 
		"singletip2": "<b>Para salvaguardar este monedero</b> debe imprimir o registrar de otro modo la dirección Bitcoin y la clave privada. Es importante hacer una copia de seguridad de la clave privada y almacenarla en un lugar seguro. Este sitio no tiene conocimiento de su clave privada. Si está familiarizado con PGP, puede descargar esta página HTML todo en uno y comprobar que tiene una versión auténtica del autor de este sitio haciendo coincidir el hash SHA256 de este HTML con el hash SHA256 disponible en el documento de historial de versiones firmadas vinculado en el pie de página de este sitio. Si deja/actualiza el sitio o presiona el botón Generar nueva dirección, se generará una nueva clave privada y la clave privada mostrada anteriormente no será recuperable.	Su clave privada Bitcoin debe mantenerse en secreto. Quienquiera que comparta la clave privada tiene acceso para gastar todos los bitcoins asociados con esa dirección. Si imprime su billetera, guárdela en una bolsa con cremallera para mantenerla a salvo del agua. Trata una cartera de papel como dinero en efectivo.", 
		"singletip3": "<b>Añadir fondos</b> a esta cartera instruyendo a otros a enviar bitcoins a su dirección Bitcoin.", 
		"singletip4": "<b>Compruebe su saldo</b> yendo a blockchain.info o blockexplorer.com e introduciendo su dirección Bitcoin.", 
		"singletip5": "<b>Pasa tus bitcoins</b> yendo a blockchain.info y barrer todo el saldo de tu clave privada en tu cuenta en su sitio web. También puede gastar sus fondos descargando uno de los populares clientes bitcoin p2p e importando su clave privada a la cartera del cliente p2p. Tenga en cuenta cuando importe su única clave a un cliente bitcoin p2p y gaste fondos, su clave se incluirá con otras claves privadas en el monedero del cliente p2p. Cuando realice una transacción, su cambio se enviará a otra dirección bitcoin dentro de la billetera del cliente p2p. A continuación, debe hacer una copia de seguridad de la cartera del cliente p2p y mantenerlo seguro, ya que sus bitcoins restantes se almacenarán allí. Satoshi aconsejó que uno nunca debe eliminar una billetera.", 
		"singleshare": "COMPARTIDA",
		...
		"paperlabelencrypt": "BIP38 Encriptar?", 
		...
		"detaillabelpassphrase": "BIP38 cONTRASEÑA", 
		"detailbip38decryptbutton": "Desencriptar BIP38", 
		"detailbip38encryptbutton": "Encriptar BIP38", 
		"detaillabelq1": "¿Cómo hago una billetera usando dados? Qué es B6?", 
		"detaila1": "Una parte importante de la creación de una billetera Bitcoin es asegurar que los números aleatorios utilizados para crear la cartera son verdaderamente aleatorios. La aleatoriedad física es mejor que la pseudo-aleatoriedad generada por ordenador. La forma más fácil de generar aleatoriedad física es con dados. Para crear una clave privada Bitcoin sólo necesita un dado de seis lados que se rueda 99 veces. Detenerse cada vez para registrar el valor del dado. Al registrar los valores, siga estas reglas: 1,1, 2, 2, 3, 4, 5, 5, 6, 0. Al hacer esto está grabando el gran número aleatorio, su clave privada, en formato B6 o base 6. A continuación, puede introducir la clave privada base 6 de 99 caracteres en el campo de texto anterior y hacer clic en Ver detalles. A continuación, verá la dirección Bitcoin asociada con su clave privada. También debe tomar nota de su clave privada en formato WIF, ya que es más ampliamente utilizada."
	};
})(ninja.translator);